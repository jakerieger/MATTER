...
void SolidEditorConfig::Load(JSON config) {
    ...
    mEditorPreferences.generalPreferences.theme                        = config["generalPreferences"]["theme"];
...
void SolidEditorConfig::Save() {
    ...
    config["generalPreferences"]["theme"]                        = mEditorPreferences.generalPreferences.theme;
...
void SolidEditorConfig::InitConfig() {
    ...
    config["generalPreferences"]["theme"]                        = "Default";
